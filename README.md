...
-------------
>
Tidal Connect operates based on it with the value being "card number" in /etc/asound.conf". After the installation is complete, you can modify the DAC configuration in this file: /root/tidal-connect-docker/Docker/entrypoint.sh. 
